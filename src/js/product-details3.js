...
function fetchProductDetails() {
  ...
  const product = {
    ...
    DescriptionHtmlSimple:
      "The North Face Talus Tent is perfect for a fun night under the stars. It features durable construction, a roomy interior, and an advanced Featherlite NSL pole system for easy pitching.",
